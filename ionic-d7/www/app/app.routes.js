...
(function () {
  ...
  angular.module('drupalionicDemo.routes', ['ngStorage',
    ...
    'drupalionicDemo.businessFeed.controller',
    'drupalionicDemo.businessFeed.businessDetail.controller',
    'drupalionicDemo.businessFeed.service'])
  ...
  function configFunction($stateProvider, $urlRouterProvider, $localStorageProvider, AuthenticationServiceConstant) {
    ...
    $stateProvider
      ...
      .state('app.businessFeed', {
        ...
        resolve: {
          actualBusinesses: function (BusinessFeedService, $rootScope) {
            $rootScope.$broadcast('loading:show', {loading_settings: {template: "<p><ion-spinner></ion-spinner><br/>Loading initial business...</p>"}});
            return BusinessFeedService.getAll().finally(function () {
              $rootScope.$broadcast('loading:hide');
            });
          }
        }
      ...
      .state('app.businessDetail', {
        ...
        resolve: {
          businessDetail: function (BusinessFeedService, $stateParams) {
            return BusinessFeedService.get({nid: $stateParams.nid});
          }
        }
      });
